 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 157.48, 157.48, 2560.00, 550.00 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      {1000, 600, 100, 300}
